...
var len__4736__auto___42387 = arguments.length;
var i__4737__auto___42388 = (0);
while(true){
if((i__4737__auto___42388 < len__4736__auto___42387)){
args__4742__auto__.push((arguments[i__4737__auto___42388]));

var G__42389 = (i__4737__auto___42388 + (1));
i__4737__auto___42388 = G__42389;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42307){
var G__42308 = cljs.core.first(seq42307);
var seq42307__$1 = cljs.core.next(seq42307);
var G__42309 = cljs.core.first(seq42307__$1);
var seq42307__$2 = cljs.core.next(seq42307__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42308,G__42309,seq42307__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42330_SHARP_){
return (!((cljs.core.meta(p1__42330_SHARP_) == null)));
})))){
...
var map__42343 = opts;
var map__42343__$1 = (((((!((map__42343 == null))))?(((((map__42343.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42343.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42343):map__42343);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42343__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42347){var _e__41273__auto__ = e42347;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e42350){var _e__41273__auto__ = e42350;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42356 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42357 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42357);

try{var map__42358 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42358__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42356);
}});
...
var temp__5733__auto___42482 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42482)){
var managed_print_level_42485 = temp__5733__auto___42482;
var _STAR_print_level_STAR__orig_val__42370_42486 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42371_42487 = managed_print_level_42485;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42371_42487);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42364_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42364_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42370_42486);
}} else {
job_fn();
}
