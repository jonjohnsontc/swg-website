...
var G__50217 = clojure.zip.node(loc);
var fexpr__50216 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__50216.cljs$core$IFn$_invoke$arity$1 ? fexpr__50216.cljs$core$IFn$_invoke$arity$1(G__50217) : fexpr__50216.call(null,G__50217));
});
/**
...
var G__50219 = clojure.zip.node(loc);
var fexpr__50218 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__50218.cljs$core$IFn$_invoke$arity$1 ? fexpr__50218.cljs$core$IFn$_invoke$arity$1(G__50219) : fexpr__50218.call(null,G__50219));
} else {
...
var fexpr__50220 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__50220.cljs$core$IFn$_invoke$arity$2 ? fexpr__50220.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__50220.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__50224 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50224,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50224,(1),null);
var vec__50227 = clojure.zip.children(loc);
...
var vec__50231 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50231,(0),null);
var map__50234 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50231,(1),null);
...
var path = map__50234__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50234__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50234__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50234__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50234__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50234__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__50253 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50253,(0),null);
var map__50256 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50253,(1),null);
...
var path = map__50256__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50256__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__50257 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50256__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__50272 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50272,(0),null);
var map__50275 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50272,(1),null);
...
var path = map__50275__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50275__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50275__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return r;
} else {
...
var vec__50279 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50279,(0),null);
var map__50282 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50279,(1),null);
...
var path = map__50282__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50282__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50282__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
...
var vec__50287 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50287,(0),null);
var map__50290 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50287,(1),null);
...
var path = map__50290__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50290__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50290__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__50297 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50297,(0),null);
...
var path = map__50300__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50300__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__50306 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50306,(0),null);
var map__50309 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50306,(1),null);
var map__50309__$1 = (((((!((map__50309 == null))))?(((((map__50309.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50309.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__50309):map__50309);
var path = map__50309__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50309__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__50311 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50311,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50311,(1),null);
...
var i__4737__auto___50367 = (0);
while(true){
if((i__4737__auto___50367 < len__4736__auto___50366)){
args__4742__auto__.push((arguments[i__4737__auto___50367]));

var G__50369 = (i__4737__auto___50367 + (1));
i__4737__auto___50367 = G__50369;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq50316){
var G__50317 = cljs.core.first(seq50316);
var seq50316__$1 = cljs.core.next(seq50316);
var G__50318 = cljs.core.first(seq50316__$1);
var seq50316__$2 = cljs.core.next(seq50316__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50317,G__50318,seq50316__$2);
}));
...
var G__50410 = clojure.zip.rightmost(child);
loc__$1 = G__50410;
continue;
} else {
return loc__$1;
...
var vec__50328 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50328,(0),null);
var map__50331 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50328,(1),null);
...
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50331__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50331__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50331__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__50426 = clojure.zip.rightmost(child);
loc__$1 = G__50426;
continue;
} else {
return loc__$1;
