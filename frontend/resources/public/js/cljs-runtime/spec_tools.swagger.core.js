...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__66736 = cljs.core.get_global_hierarchy;
return (fexpr__66736.cljs$core$IFn$_invoke$arity$0 ? fexpr__66736.cljs$core$IFn$_invoke$arity$0() : fexpr__66736.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__66762){
var map__66766 = p__66762;
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66766__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66766__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__66781 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66781,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66781,(1),null);
...
var method_cache__4621__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__66799 = cljs.core.get_global_hierarchy;
return (fexpr__66799.cljs$core$IFn$_invoke$arity$0 ? fexpr__66799.cljs$core$IFn$_invoke$arity$0() : fexpr__66799.call(null));
})());
...
var map__66810 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66810__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66810__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__66814){
var vec__66815 = p__66814;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66815,(0),null);
var map__66818 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66815,(1),null);
...
var schema = map__66818__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66818__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4621__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4622__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__66826 = cljs.core.get_global_hierarchy;
return (fexpr__66826.cljs$core$IFn$_invoke$arity$0 ? fexpr__66826.cljs$core$IFn$_invoke$arity$0() : fexpr__66826.call(null));
})());
...
})(),(function (){var iter__4529__auto__ = (function spec_tools$swagger$core$iter__66830(s__66831){
...
var c__4527__auto__ = cljs.core.chunk_first(s__66831__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__66833 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__66832 = (0);
while(true){
if((i__66832 < size__4528__auto__)){
var vec__66842 = cljs.core._nth(c__4527__auto__,i__66832);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66842,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66842,(1),null);
cljs.core.chunk_append(b__66833,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__66833),spec_tools$swagger$core$iter__66830(cljs.core.chunk_rest(s__66831__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__66833),null);
}
} else {
var vec__66858 = cljs.core.first(s__66831__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66858,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66858,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__66830(cljs.core.rest(s__66831__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__66866){
var vec__66867 = p__66866;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66867,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66867,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__66874,p){
var vec__66875 = p__66874;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66875,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66875,(1),null);
var acc__$1 = vec__66875;
