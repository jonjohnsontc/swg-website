...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k49132,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49132,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__49161){
var vec__49162 = p__49161;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49162,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49162,(1),null);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49131){
var self__ = this;
var G__49131__$1 = this;
return (new cljs.core.RecordIter((0),G__49131__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this49133,other49134){
var self__ = this;
var this49133__$1 = this;
return (((!((other49134 == null)))) && ((this49133__$1.constructor === other49134.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49133__$1.s,other49134.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49133__$1.__extmap,other49134.__extmap)));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__49131){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__49185 = cljs.core.keyword_identical_QMARK_;
var expr__49186 = k__4388__auto__;
if(cljs.core.truth_((pred__49185.cljs$core$IFn$_invoke$arity$2 ? pred__49185.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"s","s",1705939918),expr__49186) : pred__49185.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__49186)))){
return (new rewrite_clj.node.comment.CommentNode(G__49131,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__49131),null));
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__49131){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.s,G__49131,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__49137){
var extmap__4419__auto__ = (function (){var G__49198 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__49137,new cljs.core.Keyword(null,"s","s",1705939918));
if(cljs.core.record_QMARK_(G__49137)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49198);
} else {
return G__49198;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__49137),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
