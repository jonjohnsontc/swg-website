...
var o41557 = temp__5733__auto__;
var temp__5733__auto____$1 = (o41557["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o41558 = temp__5733__auto____$1;
return (o41558["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41227__auto__ = f;
return (o__41227__auto__["toString"]).call(o__41227__auto__);
} else {
return "";
}
}catch (e41568){var _ = e41568;
return "";
}});
...
try{var o__41227__auto___42231 = t;
(o__41227__auto___42231["cljs$lang$ctorPrWriter"]).call(o__41227__auto___42231,t,writer);
}catch (e41586){var __42233 = e41586;
}
...
var char_code = (function (){var o__41227__auto__ = (new String(char$));
return (o__41227__auto__["charCodeAt"]).call(o__41227__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41227__auto__ = String;
return (o__41227__auto__["fromCharCode"]).call(o__41227__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41623 = num_code;
switch (G__41623) {
case (1):
return (185);
...
var o__41227__auto__ = String;
return (o__41227__auto__["fromCharCode"]).call(o__41227__auto__,superscript_code);
});
/**
...
}catch (e41682){var _e__41273__auto__ = e41682;
return false;
}})())){
...
var vec__41689 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41689,(0),null);
...
var len__4736__auto___42257 = arguments.length;
var i__4737__auto___42258 = (0);
while(true){
if((i__4737__auto___42258 < len__4736__auto___42257)){
args__4742__auto__.push((arguments[i__4737__auto___42258]));

var G__42259 = (i__4737__auto___42258 + (1));
i__4737__auto___42258 = G__42259;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41755){
var vec__41756 = p__41755;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41756,(0),null);
...
var G__42265 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42266 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42265;
remaining_tokens = G__42266;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41742){
var G__41743 = cljs.core.first(seq41742);
var seq41742__$1 = cljs.core.next(seq41742);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41743,seq41742__$1);
}));
...
var vec__41802 = cljs.core.split_with((function (p1__41791_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41791_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41802,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41802,(1),null);
...
var vec__41828 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41828,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41828,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42275 = cljs.core.rest(remaining_tokens);
var G__42276 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42275;
name_tokens = G__42276;
continue;
} else {
...
var vec__41901 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41901,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41901,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41901,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41901,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41901,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41901,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__41936 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41936,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41936,(1),null);
var vec__41939 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41939,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41939,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41956 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41956) : devtools.munging.parse_fn_info_deep.call(null,G__41956));
})()));
}
} else {
return fn_info;
...
var G__42303 = (arity + (1));
var G__42304 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42000){
var vec__42001 = p__42000;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42001,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42001,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42025_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42025_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42026_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42026_SHARP_);
}),sorted_infos);
...
while(true){
if((i__4737__auto___42316 < len__4736__auto___42314)){
args__4742__auto__.push((arguments[i__4737__auto___42316]));

var G__42317 = (i__4737__auto___42316 + (1));
i__4737__auto___42316 = G__42317;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42045){
var vec__42046 = p__42045;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42046,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42037){
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42113__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42113__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42113__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42113__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42114 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42114,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42114,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42114,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42114,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42114,(4),null);
...
var o__41227__auto__ = f;
return (o__41227__auto__["getBasis"]).call(o__41227__auto__);
});
/**
...
}catch (e42133){var _e__41273__auto__ = e42133;
...
var G__42337 = (obj[cljs.core.first(path)]);
var G__42338 = cljs.core.rest(path);
obj = G__42337;
path = G__42338;
continue;
} else {
...
var _STAR_ = (function (accum,p__42149){
var vec__42150 = p__42149;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42150,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42150,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42173){
var vec__42174 = p__42173;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42174,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42174,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42174,(2),null);
...
var post_process = (function (p__42224){
var vec__42225 = p__42224;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42225,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42225,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42211_SHARP_){
return (obj[cljs.core.first(p1__42211_SHARP_)]);
}),sorted_matches);
