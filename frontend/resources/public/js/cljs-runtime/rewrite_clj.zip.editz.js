...
var G__50504 = (function (){var G__50505 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__50505) : f.call(null,G__50505));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__50504) : rewrite_clj.node.coerce.call(null,G__50504));
});
/**
...
var len__4736__auto___50575 = arguments.length;
var i__4737__auto___50576 = (0);
while(true){
if((i__4737__auto___50576 < len__4736__auto___50575)){
args__4742__auto__.push((arguments[i__4737__auto___50576]));

var G__50577 = (i__4737__auto___50576 + (1));
i__4737__auto___50576 = G__50577;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__50506_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__50506_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq50507){
var G__50508 = cljs.core.first(seq50507);
var seq50507__$1 = cljs.core.next(seq50507);
var G__50509 = cljs.core.first(seq50507__$1);
var seq50507__$2 = cljs.core.next(seq50507__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50508,G__50509,seq50507__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__50541 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__50541) : str_fn.call(null,G__50541));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__50542 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__50542) : str_fn.call(null,G__50542));
})()):null)));
...
var G__50560 = rewrite_clj.zip.base.tag(zloc);
var G__50560__$1 = (((G__50560 instanceof cljs.core.Keyword))?G__50560.fqn:null);
switch (G__50560__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__50555_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50555_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__50556_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50556_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50560__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__50571 = rewrite_clj.zip.base.tag(zloc);
var G__50571__$1 = (((G__50571 instanceof cljs.core.Keyword))?G__50571.fqn:null);
switch (G__50571__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__50567_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50567_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
