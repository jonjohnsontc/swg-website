...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__50334,k,f){
var vec__50335 = p__50334;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50335,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50335,(1),null);
var loc = vec__50335;
...
var G__50422 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__50422;
continue;
}
break;
...
var G__50424 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__50424;
continue;
} else {
return zloc__$1;
...
var G__50427 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__50427;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__50352){
var vec__50353 = p__50352;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50353,(0),null);
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__50360){
var vec__50361 = p__50360;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50361,(0),null);
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50364__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__50361;
if(cljs.core.seq(r)){
...
var vec__50385 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50385,(0),null);
var map__50388 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50385,(1),null);
...
var path = map__50388__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50388__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50388__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50388__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50388__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
