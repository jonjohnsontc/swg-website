...
return (function() { 
var G__47791__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__47791 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__47792__i = 0, G__47792__a = new Array(arguments.length -  0);
while (G__47792__i < G__47792__a.length) {G__47792__a[G__47792__i] = arguments[G__47792__i + 0]; ++G__47792__i;}
  args = new cljs.core.IndexedSeq(G__47792__a,0,null);
} 
return G__47791__delegate.call(this,args);};
G__47791.cljs$lang$maxFixedArity = 0;
G__47791.cljs$lang$applyTo = (function (arglist__47793){
var args = cljs.core.seq(arglist__47793);
return G__47791__delegate(args);
});
G__47791.cljs$core$IFn$_invoke$arity$variadic = G__47791__delegate;
return G__47791;
})()
;
} else {
...
var G__47600 = o;
goog.object.set(G__47600,day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.cached_custom_prop_name(k),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.convert_prop_value(v));
...
while (G__47799__i < G__47799__a.length) {G__47799__a[G__47799__i] = arguments[G__47799__i + 0]; ++G__47799__i;}
  args = new cljs.core.IndexedSeq(G__47799__a,0,null);
} 
...
var G__47604 = props;
var G__47604__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47604,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__47604);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47604__$1,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__47604__$1;
}
});
...
var props__$1 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.set_id_class((function (){var G__47608 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47608,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__47608;
}
})(),id_class);
...
day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.input_node_set_value = (function day8$re_frame_10x$inlined_deps$reagent$v0v10v0$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__47620){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47621__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__47640_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.input_handle_change(this$,on_change,p1__47640_SHARP_);
}));
} else {
return null;
}
...
var vec__47665 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47665,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47665,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47665,(2),null);
...
var temp__5739__auto___47835 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___47835 == null)){
} else {
var key_47836 = temp__5739__auto___47835;
(jsprops.key = key_47836);
}
...
var temp__5739__auto___47842 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___47842 == null)){
} else {
var key_47843 = temp__5739__auto___47842;
(jsprops.key = key_47843);
}
...
var G__47701 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__47701) : day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.as_element.call(null,G__47701));
} else {
var temp__5739__auto___47865 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___47865 == null)){
} else {
var key_47866 = temp__5739__auto___47865;
(jsprops.key = key_47866);
}
...
var G__47703 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__47703)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__47703)){
return x;
} else {
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq47704){
var G__47705 = cljs.core.first(seq47704);
var seq47704__$1 = cljs.core.next(seq47704);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47705,seq47704__$1);
}));
...
break;
default:
var G__47875 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__47875;
continue;
...
var ctx = ({});
var vec__47719 = day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.ratom.check_derefs((function (){
return day8.re_frame_10x.inlined_deps.reagent.v0v10v0.reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47719,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47719,(1),null);
...
var G__47749 = (cljs.core.count(argv) - first_child);
switch (G__47749) {
case (0):
