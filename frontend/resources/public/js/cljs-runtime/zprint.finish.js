...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__48795_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48795_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__48795_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__48796){
var vec__48797 = p__48796;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48797,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48797,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__48806,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48807__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48807__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48807__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__48814 = (function (){var or__4126__auto__ = color;
...
var fexpr__48813 = (function (){var G__48815 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__48815) : style_map.call(null,G__48815));
})();
return (fexpr__48813.cljs$core$IFn$_invoke$arity$1 ? fexpr__48813.cljs$core$IFn$_invoke$arity$1(G__48814) : fexpr__48813.call(null,G__48814));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__48822){
var vec__48823 = p__48822;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48823,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48823,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48823,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__48831){
var vec__48832 = p__48831;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48832,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48832,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48832,(2),null);
...
var G__49036 = cljs.core.next(ssv);
var G__49037 = (this_ssv == null);
var G__49038 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__49039 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__49036;
doing_nil_QMARK_ = G__49037;
last_elide = G__49038;
out = G__49039;
continue;
}
...
var vec__48858 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48858,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48858,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48858,(2),null);
...
var G__49045 = cljs.core.next(remaining_cvec);
var G__49046 = new_idx;
var G__49047 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__49045;
idx = G__49046;
out = G__49047;
continue;
}
...
var G__49064 = cljs.core.next(ss_vec);
...
var G__49066 = (pos + cljs.core.count(cljs.core.first(ss)));
var G__49067 = ((((same_style_QMARK_) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(initial_pos,pos))))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.add_length(current)));
ss_vec = G__49064;
current = G__49065;
pos = G__49066;
out = G__49067;
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__48894,cursor_vec){
var vec__48898 = p__48894;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48898,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48898,(1),null);
var focus_vec = vec__48898;
...
var vec__48908 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48908,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48908,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__48928){
var vec__48929 = p__48928;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48929,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48929,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__48944,existing_count){
var vec__48945 = p__48944;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48945,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48945,(1),null);
...
return cljs.core.filterv((function (p1__48937_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__48937_SHARP_))));
...
var vec__48972 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48972,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48972,(1),null);
var cvec_element = vec__48972;
if((cvec_element == null)){
var G__49083 = cljs.core.next(cvec_nl);
var G__49084 = (idx + (1));
var G__49085 = start;
var G__49086 = out;
cvec_nl = G__49083;
...
var G__49087 = cljs.core.next(cvec_nl);
var G__49088 = (idx + (1));
var G__49089 = idx;
var G__49090 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__49087;
idx = G__49088;
start = G__49089;
out = G__49090;
...
var G__49093 = (idx + (1));
var G__49094 = (idx + (1));
var G__49095 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__49092;
idx = G__49093;
start = G__49094;
out = G__49095;
...
var G__49096 = cljs.core.next(cvec_nl);
var G__49097 = (idx + (1));
var G__49098 = idx;
var G__49099 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__49096;
idx = G__49097;
start = G__49098;
out = G__49099;
...
var G__49102 = (idx + (1));
var G__49103 = start;
var G__49104 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__49101;
idx = G__49102;
start = G__49103;
out = G__49104;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__48982_SHARP_,p2__48981_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__48981_SHARP_)){
return cljs.core.reduced(p1__48982_SHARP_);
} else {
return (p1__48982_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__48987,p__48988){
var vec__48989 = p__48987;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48989,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48989,(1),null);
var vec__48992 = p__48988;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48992,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48992,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__49006,cvec,focus_vec){
var map__49007 = p__49006;
var map__49007__$1 = (((((!((map__49007 == null))))?(((((map__49007.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49007.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49007):map__49007);
var options = map__49007__$1;
var map__49008 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49007__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49008__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49008__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49008__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49005_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__49005_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
