...
if((c === "\n")){
var G__50186 = escape_QMARK_;
var G__50187 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__50186;
lines = G__50187;
continue;
} else {
buf.append(c);

var G__50188 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__50189 = lines;
escape_QMARK_ = G__50188;
lines = G__50189;
continue;
...
var G__50169 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__50169) : rewrite_clj.node.string_node.call(null,G__50169));
});
...
var G__50171 = cljs.core.re_pattern(regex);
var G__50172 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__50171,G__50172) : rewrite_clj.node.token_node.call(null,G__50171,G__50172));
});
