...
var G__51800 = o;
goog.object.set(G__51800,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__51874__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51874 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51875__i = 0, G__51875__a = new Array(arguments.length -  0);
while (G__51875__i < G__51875__a.length) {G__51875__a[G__51875__i] = arguments[G__51875__i + 0]; ++G__51875__i;}
  args = new cljs.core.IndexedSeq(G__51875__a,0,null);
} 
return G__51874__delegate.call(this,args);};
G__51874.cljs$lang$maxFixedArity = 0;
G__51874.cljs$lang$applyTo = (function (arglist__51876){
var args = cljs.core.seq(arglist__51876);
return G__51874__delegate(args);
});
G__51874.cljs$core$IFn$_invoke$arity$variadic = G__51874__delegate;
return G__51874;
})()
;
} else {
...
var G__51814 = o;
goog.object.set(G__51814,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__51819 = props;
var G__51819__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51819,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51819);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51819__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__51819__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51821 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51821,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51821;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__51823){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51824__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__51830_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__51830_SHARP_);
}));
} else {
return null;
}
...
var vec__51840 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51840,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51840,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51840,(2),null);
...
var temp__5739__auto___51913 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___51913 == null)){
} else {
var key_51917 = temp__5739__auto___51913;
(jsprops.key = key_51917);
}
...
var temp__5739__auto___51924 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___51924 == null)){
} else {
var key_51925 = temp__5739__auto___51924;
(jsprops.key = key_51925);
}
...
var G__51852 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__51852) : reagent.impl.template.as_element.call(null,G__51852));
} else {
var temp__5739__auto___51933 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___51933 == null)){
} else {
var key_51934 = temp__5739__auto___51933;
...
var G__51855 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__51855)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__51855)){
return x;
} else {
...
while(true){
if((i__4737__auto___51945 < len__4736__auto___51943)){
args__4742__auto__.push((arguments[i__4737__auto___51945]));

var G__51946 = (i__4737__auto___51945 + (1));
i__4737__auto___51945 = G__51946;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq51856){
var G__51857 = cljs.core.first(seq51856);
var seq51856__$1 = cljs.core.next(seq51856);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51857,seq51856__$1);
}));
...
break;
default:
var G__51970 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__51970;
continue;
...
var ctx = ({});
var vec__51865 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51865,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51865,(1),null);
...
var G__51869 = (cljs.core.count(argv) - first_child);
switch (G__51869) {
case (0):
