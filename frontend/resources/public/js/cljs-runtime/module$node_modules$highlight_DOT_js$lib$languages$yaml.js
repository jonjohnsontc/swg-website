...
{end:",",endsWithParent:!0,excludeEnd:!0,contains:[],keywords:"true false yes no null",relevance:0};hljs=[{className:"attr",variants:[{begin:"\\w[\\w :\\/.-]*:(?\x3d[ \t]|$)"},{begin:'"\\w[\\w :\\/.-]*":(?\x3d[ \t]|$)'},{begin:"'\\w[\\w :\\/.-]*':(?\x3d[ \t]|$)"}]},{className:"meta",begin:"^---\\s*$",relevance:10},{className:"string",begin:"[\\|\x3e]([1-9]?[+-])?[ ]*\\n( +)[^ ][^\\n]*\\n(\\2[^\\n]+\\n?)*"},{begin:"\x3c%[%\x3d-]?",end:"[%-]?%\x3e",subLanguage:"ruby",excludeBegin:!0,excludeEnd:!0,relevance:0},
...
VALUE_CONTAINER.contains=STRING;return{name:"YAML",case_insensitive:!0,aliases:["yml","YAML"],contains:hljs}}}
