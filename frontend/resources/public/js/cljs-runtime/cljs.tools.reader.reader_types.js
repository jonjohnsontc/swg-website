...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_42969 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_42969(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_42974 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_42974(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42979 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_42979(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42984 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_42984(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42988 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_42988(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42991 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_42991(reader);
}
});
...
var G__43041 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43042 = s.append(c);
c = G__43041;
s = G__43042;
continue;
}
