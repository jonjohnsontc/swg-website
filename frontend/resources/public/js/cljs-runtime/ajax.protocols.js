...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_64607 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_64607(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_64613 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_64613(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_64623 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_64623(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_64624 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_64624(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_64630 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_64630(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_64636 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_64636(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_64637 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_64637(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_64639 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_64639(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_64645 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_64645(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_64646 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_64646(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k64523,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k64523,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__64531){
var vec__64532 = p__64531;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64532,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64532,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this64524,other64525){
var self__ = this;
var this64524__$1 = this;
return (((!((other64525 == null)))) && ((this64524__$1.constructor === other64525.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64524__$1.status,other64525.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64524__$1.body,other64525.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64524__$1.status_text,other64525.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64524__$1.headers,other64525.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64524__$1.was_aborted,other64525.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this64524__$1.__extmap,other64525.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__64522){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__64568 = cljs.core.keyword_identical_QMARK_;
var expr__64569 = k__4388__auto__;
if(cljs.core.truth_((pred__64568.cljs$core$IFn$_invoke$arity$2 ? pred__64568.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__64569) : pred__64568.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__64569)))){
return (new ajax.protocols.Response(G__64522,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64568.cljs$core$IFn$_invoke$arity$2 ? pred__64568.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__64569) : pred__64568.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__64569)))){
return (new ajax.protocols.Response(self__.status,G__64522,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64568.cljs$core$IFn$_invoke$arity$2 ? pred__64568.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__64569) : pred__64568.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__64569)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__64522,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64568.cljs$core$IFn$_invoke$arity$2 ? pred__64568.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__64569) : pred__64568.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__64569)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__64522,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__64568.cljs$core$IFn$_invoke$arity$2 ? pred__64568.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__64569) : pred__64568.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__64569)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__64522,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__64522),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__64522){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__64522,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__64529){
var extmap__4419__auto__ = (function (){var G__64586 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__64529,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
...
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__64529),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__64529),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__64529),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__64529),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__64529),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
