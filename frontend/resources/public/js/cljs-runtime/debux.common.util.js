...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__66733_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__66733_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66732_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__66732_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__66735_SHARP_){
return (((p1__66735_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__66735_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__66755,mapping){
...
var state = map__66756__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66756__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66756__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66756__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__66753_SHARP_){
if((p1__66753_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__66753_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__66967 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__66968 = clojure.zip.next(loc);
loc = G__66968;
continue;
}
}
...
var len__4736__auto___66991 = arguments.length;
var i__4737__auto___66996 = (0);
while(true){
if((i__4737__auto___66996 < len__4736__auto___66991)){
args__4742__auto__.push((arguments[i__4737__auto___66996]));

var G__66998 = (i__4737__auto___66996 + (1));
i__4737__auto___66996 = G__66998;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__66854){
var vec__66855 = p__66854;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66855,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq66836){
var G__66837 = cljs.core.first(seq66836);
var seq66836__$1 = cljs.core.next(seq66836);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__66837,seq66836__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__66861_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__66861_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__66870_67002 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__66871_67003 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__66872_67004 = true;
var _STAR_print_fn_STAR__temp_val__66873_67005 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__66872_67004);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__66873_67005);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__66871_67003);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__66870_67002);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__66865_SHARP_){
return debux.common.util.prepend_bars(p1__66865_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__67013 = cljs.core.next(opts__$1);
var G__67014 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__67013;
acc = G__67014;
continue;
} else {
if(typeof f === 'string'){
var G__67015 = cljs.core.next(opts__$1);
var G__67016 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__67015;
acc = G__67016;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__67017 = cljs.core.nnext(opts__$1);
var G__67018 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__67017;
acc = G__67018;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__67022 = cljs.core.next(opts__$1);
var G__67023 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__67022;
acc = G__67023;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__66893 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__66893.cljs$core$IFn$_invoke$arity$1 ? fexpr__66893.cljs$core$IFn$_invoke$arity$1(f) : fexpr__66893.call(null,f));
})())){
var G__67024 = cljs.core.next(opts__$1);
var G__67025 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__67024;
acc = G__67025;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__66897 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__66897.cljs$core$IFn$_invoke$arity$1 ? fexpr__66897.cljs$core$IFn$_invoke$arity$1(f) : fexpr__66897.call(null,f));
})())){
var G__67029 = cljs.core.nnext(opts__$1);
var G__67030 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__67029;
acc = G__67030;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__67031 = cljs.core.next(opts__$1);
var G__67032 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__67031;
acc = G__67032;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__66915){
var vec__66921 = p__66915;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66921,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66921,(1),null);
...
var G__66933 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__66932 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__66932.cljs$core$IFn$_invoke$arity$1 ? fexpr__66932.cljs$core$IFn$_invoke$arity$1(G__66933) : fexpr__66932.call(null,G__66933));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__66935 = quoted_form;
var G__66936 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__66935,G__66936) : debux.common.util.remove_d.call(null,G__66935,G__66936));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__66938 = quoted_form;
var G__66939 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__66938,G__66939) : debux.common.util.remove_d.call(null,G__66938,G__66939));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__67040__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__66948 = quoted_form;
var G__66950 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__66948,G__66950) : debux.common.util.remove_d.call(null,G__66948,G__66950));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__67040 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__67041__i = 0, G__67041__a = new Array(arguments.length -  0);
while (G__67041__i < G__67041__a.length) {G__67041__a[G__67041__i] = arguments[G__67041__i + 0]; ++G__67041__i;}
  arg = new cljs.core.IndexedSeq(G__67041__a,0,null);
} 
return G__67040__delegate.call(this,arg);};
G__67040.cljs$lang$maxFixedArity = 0;
G__67040.cljs$lang$applyTo = (function (arglist__67042){
var arg = cljs.core.seq(arglist__67042);
return G__67040__delegate(arg);
});
G__67040.cljs$core$IFn$_invoke$arity$variadic = G__67040__delegate;
return G__67040;
})()
;
});
...
var G__67044 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__67044;
continue;
} else {
...
var G__67045 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__67045;
continue;
} else {
var G__67046 = clojure.zip.next(loc);
loc = G__67046;
continue;
