...
var len__4736__auto___55635 = arguments.length;
var i__4737__auto___55636 = (0);
while(true){
if((i__4737__auto___55636 < len__4736__auto___55635)){
args_arr__4757__auto__.push((arguments[i__4737__auto___55636]));

var G__55637 = (i__4737__auto___55636 + (1));
i__4737__auto___55636 = G__55637;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq55588){
...
var G__55591 = cljs.core.first(seq55588__$2);
var seq55588__$3 = cljs.core.next(seq55588__$2);
var G__55592 = cljs.core.first(seq55588__$3);
var seq55588__$4 = cljs.core.next(seq55588__$3);
var G__55593 = cljs.core.first(seq55588__$4);
var seq55588__$5 = cljs.core.next(seq55588__$4);
var G__55594 = cljs.core.first(seq55588__$5);
var seq55588__$6 = cljs.core.next(seq55588__$5);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55589,G__55590,G__55591,G__55592,G__55593,G__55594,seq55588__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__55615){
var vec__55616 = p__55615;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55616,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55616,(1),null);
