...
var len__4736__auto___41468 = arguments.length;
var i__4737__auto___41470 = (0);
while(true){
if((i__4737__auto___41470 < len__4736__auto___41468)){
args__4742__auto__.push((arguments[i__4737__auto___41470]));

var G__41475 = (i__4737__auto___41470 + (1));
i__4737__auto___41470 = G__41475;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq41360){
var G__41361 = cljs.core.first(seq41360);
var seq41360__$1 = cljs.core.next(seq41360);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41361,seq41360__$1);
}));
...
return cljs.core.some((function (p1__41390_SHARP_){
return (p1__41390_SHARP_ === object);
}),history);
});
