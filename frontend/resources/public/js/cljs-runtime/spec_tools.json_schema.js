...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.json-schema","default","spec-tools.json-schema/default",-2093938695)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__66420 = cljs.core.get_global_hierarchy;
return (fexpr__66420.cljs$core$IFn$_invoke$arity$0 ? fexpr__66420.cljs$core$IFn$_invoke$arity$0() : fexpr__66420.call(null));
})());
...
var map__66520 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66520__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66520__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66520__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66520__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var map__66551 = spec_tools.parse.parse_spec(form);
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66551__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__66558 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__66558__$1)].join('')));
...
var vec__66626 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66626,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66626,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66626,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66626,(3),null);
...
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66637,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66637,(1),null);
...
var extra_info = (function (){var G__66645 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__66645,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__66645;
}
})();
