...
var vec__55541 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__55547 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55547,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55547,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55541,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55541,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__55564){
var vec__55566 = p__55564;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55566,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55566,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55574,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55574,(1),null);
...
var vec__55581 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55581,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55581,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55581,(2),null);
var vec__55584 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55584,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55584,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55584,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__55605){
var vec__55606 = p__55605;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55606,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55606,(1),null);
...
var len__4736__auto___55779 = arguments.length;
var i__4737__auto___55780 = (0);
while(true){
if((i__4737__auto___55780 < len__4736__auto___55779)){
args__4742__auto__.push((arguments[i__4737__auto___55780]));

var G__55784 = (i__4737__auto___55780 + (1));
i__4737__auto___55780 = G__55784;
continue;
} else {
}
break;
...
var vec__55612 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55612,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55612,(1),null);
...
var G__55619 = zprint.core.parse_string_all_options(rest_options);
var G__55620 = zprint.core.zprint_str_internal;
var G__55621 = ":parse-string-all? call";
var G__55622 = (function (){var G__55623 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__55623) : zprint.zutil.edn_STAR_.call(null,G__55623));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__55619,G__55620,G__55621,G__55622) : zprint.core.process_multiple_forms.call(null,G__55619,G__55620,G__55621,G__55622));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__55624 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55624,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55624,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq55609){
var G__55610 = cljs.core.first(seq55609);
var seq55609__$1 = cljs.core.next(seq55609);
var G__55611 = cljs.core.first(seq55609__$1);
var seq55609__$2 = cljs.core.next(seq55609__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55610,G__55611,seq55609__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___55820 = arguments.length;
var i__4737__auto___55821 = (0);
while(true){
if((i__4737__auto___55821 < len__4736__auto___55820)){
args__4742__auto__.push((arguments[i__4737__auto___55821]));

var G__55822 = (i__4737__auto___55821 + (1));
i__4737__auto___55821 = G__55822;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq55633){
var G__55634 = cljs.core.first(seq55633);
var seq55633__$1 = cljs.core.next(seq55633);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55634,seq55633__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___55833 = arguments.length;
var i__4737__auto___55834 = (0);
while(true){
if((i__4737__auto___55834 < len__4736__auto___55833)){
args__4742__auto__.push((arguments[i__4737__auto___55834]));

var G__55835 = (i__4737__auto___55834 + (1));
i__4737__auto___55834 = G__55835;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq55638){
var G__55639 = cljs.core.first(seq55638);
var seq55638__$1 = cljs.core.next(seq55638);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55639,seq55638__$1);
}));
...
var i__4737__auto___55849 = (0);
while(true){
if((i__4737__auto___55849 < len__4736__auto___55847)){
args__4742__auto__.push((arguments[i__4737__auto___55849]));

var G__55851 = (i__4737__auto___55849 + (1));
i__4737__auto___55849 = G__55851;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq55640){
var G__55641 = cljs.core.first(seq55640);
var seq55640__$1 = cljs.core.next(seq55640);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55641,seq55640__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___55868 = arguments.length;
var i__4737__auto___55869 = (0);
while(true){
if((i__4737__auto___55869 < len__4736__auto___55868)){
args__4742__auto__.push((arguments[i__4737__auto___55869]));

var G__55870 = (i__4737__auto___55869 + (1));
i__4737__auto___55869 = G__55870;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq55642){
var G__55643 = cljs.core.first(seq55642);
var seq55642__$1 = cljs.core.next(seq55642);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55643,seq55642__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__55651,form){
var vec__55653 = p__55651;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55653,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55653,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55653,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55653,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__55656 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55656,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55656,(1),null);
...
var forms = (function (){var G__55699 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__55699) : zprint.zutil.edn_STAR_.call(null,G__55699));
})();
