...
}catch (e42240){var _e = e42240;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___42284 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___42284)){
var seen_errors_42285 = temp__5733__auto___42284;
if(cljs.core.truth_(seen_errors_42285.has(self))){
} else {
seen_errors_42285.add(self);

var temp__5735__auto___42286 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___42286)){
var sense_42287 = temp__5735__auto___42286;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_42287)].join(''));
} else {
}
}
} else {
