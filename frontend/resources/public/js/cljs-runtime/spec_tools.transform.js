...
if((x instanceof cljs.core.Keyword)){
var G__64753 = spec;
var G__64754 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__64753,G__64754) : f.call(null,G__64753,G__64754));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__64755 = spec;
var G__64756 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__64755,G__64756) : f.call(null,G__64755,G__64756));
} else {
return x;
...
if(typeof x === 'number'){
var G__64757 = spec;
var G__64758 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__64757,G__64758) : f.call(null,G__64757,G__64758));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e64759){if((e64759 instanceof Error)){
var ___$1 = e64759;
return x;
} else {
throw e64759;
...
}catch (e64760){if((e64760 instanceof Error)){
var ___$1 = e64760;
return x;
} else {
throw e64760;
...
}catch (e64765){if((e64765 instanceof Error)){
var ___$1 = e64765;
return x;
} else {
throw e64765;
...
}catch (e64776){if((e64776 instanceof Error)){
var ___$1 = e64776;
return x;
} else {
throw e64776;
...
}catch (e64783){if((e64783 instanceof Error)){
var ___$1 = e64783;
return x;
} else {
throw e64783;
...
}catch (e64785){if((e64785 instanceof Error)){
var ___$1 = e64785;
return x;
} else {
throw e64785;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__64794,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64795__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__64804,x){
var map__64805 = p__64804;
var map__64805__$1 = (((((!((map__64805 == null))))?(((((map__64805.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64805.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64805):map__64805);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64805__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__64813,x){
var map__64814 = p__64813;
var map__64814__$1 = (((((!((map__64814 == null))))?(((((map__64814.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64814.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64814):map__64814);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64814__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
