...
var vec__64428 = cljs.core.rest(expr);
...
var vec__64431 = first__64430;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64431,(0),null);
var form = seq__64429__$1;
...
var G__64434 = x;
var G__64434__$1 = (((G__64434 == null))?null:spec_tools.impl.polish(G__64434));
var G__64434__$2 = (((G__64434__$1 == null))?null:cljs.core.name(G__64434__$1));
if((G__64434__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__64434__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__64435 = x;
var G__64435__$1 = (((G__64435 == null))?null:cljs.core.name(G__64435));
if((G__64435__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__64435__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__64436){
...
var data = map__64437__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64437__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64437__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64437__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64437__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__64441){
var map__64442 = p__64441;
var map__64442__$1 = (((((!((map__64442 == null))))?(((((map__64442.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64442.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64442):map__64442);
var data = map__64442__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64442__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64442__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__64444 = data;
var G__64444__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__64444,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__64444);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__64444__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__64444__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__64448 = form;
var G__64448__$1 = (((G__64448 == null))?null:cljs.core.rest(G__64448));
if((G__64448__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__64448__$1);
}
})();
var G__64449 = m;
var G__64449__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__64449,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__64445_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__64445_SHARP_)));
})):G__64449);
var G__64449__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__64449__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__64446_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__64446_SHARP_)));
})):G__64449__$1);
var G__64449__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__64449__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__64447_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__64447_SHARP_));
})):G__64449__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__64449__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__64450 = (function (){var G__64451 = form;
var G__64451__$1 = (((G__64451 == null))?null:cljs.core.rest(G__64451));
if((G__64451__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__64451__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64450__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64450__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64450__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64450__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__64460 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__64460) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__64471 = form;
var G__64471__$1 = (((G__64471 == null))?null:cljs.core.seq(G__64471));
var G__64471__$2 = (((G__64471__$1 == null))?null:cljs.core.first(G__64471__$1));
if((G__64471__$2 == null)){
return null;
} else {
var fexpr__64473 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__64473.cljs$core$IFn$_invoke$arity$1 ? fexpr__64473.cljs$core$IFn$_invoke$arity$1(G__64471__$2) : fexpr__64473.call(null,G__64471__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq64475){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__64483){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__64498){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64499__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64499__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64499__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64499__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__64496_SHARP_){
return cljs.core.map_QMARK_(p1__64496_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__64497_SHARP_){
return cljs.core.contains_QMARK_(p1__64497_SHARP_,x);
});
}),req_keys));
