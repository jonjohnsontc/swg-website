...
var fexpr__64539 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__64539.cljs$core$IFn$_invoke$arity$1 ? fexpr__64539.cljs$core$IFn$_invoke$arity$1(type) : fexpr__64539.call(null,type));
});
...
var G__64736 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__64736;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__64544 = spec_tools.impl.normalize_symbol(x);
var G__64545 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__64544,G__64545) : spec_tools.parse.parse_form.call(null,G__64544,G__64545));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__64546 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__64547 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__64546,G__64547) : spec_tools.parse.parse_form.call(null,G__64546,G__64547));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__64737 = cljs.spec.alpha.form(x);
x = G__64737;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__64551 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__64552 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__64551,G__64552) : spec_tools.parse.parse_form.call(null,G__64551,G__64552));
} else {
...
var G__64557 = parse_data;
var G__64557__$1 = (((G__64557 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__64557));
var G__64557__$2 = (((G__64557__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__64557__$1));
var G__64557__$3 = (((G__64557__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__64557__$2));
var G__64557__$4 = (((G__64557__$3 == null))?null:cljs.core.seq(G__64557__$3));
if((G__64557__$4 == null)){
return null;
} else {
return cljs.core.set(G__64557__$4);
}
}
});
...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__64562 = cljs.core.get_global_hierarchy;
return (fexpr__64562.cljs$core$IFn$_invoke$arity$0 ? fexpr__64562.cljs$core$IFn$_invoke$arity$0() : fexpr__64562.call(null));
})());
...
var map__64657 = spec_tools.impl.parse_keys(form);
var map__64657__$1 = (((((!((map__64657 == null))))?(((((map__64657.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64657.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64657):map__64657);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64657__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64657__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64657__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64657__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64657__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__64664 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__64664__$1 = (cljs.core.truth_((function (){var or__4126__auto__ = req;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64664,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__64664);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__64664__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__64664__$1;
}
}));
...
var vec__64678 = multi_spec_form;
...
var _ = first__64680;
var first__64680__$1 = cljs.core.first(seq__64679__$1);
var seq__64679__$2 = cljs.core.next(seq__64679__$1);
var multi_method_symbol = first__64680__$1;
var ___$1 = seq__64679__$2;
var form = vec__64678;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__64683){
var vec__64685 = p__64683;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64685,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64685,(1),null);
...
var type_priority = (function (p1__64690_SHARP_){
var G__64694 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(0),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(1)], null);
var G__64695 = (0);
var fexpr__64693 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__64690_SHARP_);
return (fexpr__64693.cljs$core$IFn$_invoke$arity$2 ? fexpr__64693.cljs$core$IFn$_invoke$arity$2(G__64694,G__64695) : fexpr__64693.call(null,G__64694,G__64695));
});
...
var map__64697 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__64697__$1 = (((((!((map__64697 == null))))?(((((map__64697.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64697.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64697):map__64697);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64697__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__64700 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__64700__$1 = (((((!((map__64700 == null))))?(((((map__64700.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64700.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64700):map__64700);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64700__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__64705){
var vec__64706 = p__64705;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64706,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64706,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64706,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__64722){
var vec__64723 = p__64722;
var seq__64724 = cljs.core.seq(vec__64723);
var first__64725 = cljs.core.first(seq__64724);
var seq__64724__$1 = cljs.core.next(seq__64724);
var ___$1 = first__64725;
var values = seq__64724__$1;
...
var type_priority = (function (p1__64729_SHARP_){
var G__64731 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__64730 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__64729_SHARP_);
return (fexpr__64730.cljs$core$IFn$_invoke$arity$1 ? fexpr__64730.cljs$core$IFn$_invoke$arity$1(G__64731) : fexpr__64730.call(null,G__64731));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.parse_spec,cljs.core.rest(form))));
}));
